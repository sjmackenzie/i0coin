...
const int nTotalBlocksEstimate = 180000; // Conservative estimate of total nr of blocks on main chain
...
bool CBlock::AcceptBlock()
{
    ...
    if (!fTestNet
         ...
         && (nHeight == 180000 && hash != uint256("a258d74310257d1aa02414258fe61f316c211b18395baeaddd8738dd692b7dc3"))
       )
    ...
    if (hashBestChain == hash)
        CRITICAL_BLOCK(cs_vNodes)
            BOOST_FOREACH(CNode* pnode, vNodes)
                if (nBestHeight > (pnode->nStartingHeight != -1 ? pnode->nStartingHeight - 2000 : 180000))
